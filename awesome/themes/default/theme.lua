...
local bg_dir = gfs.get_xdg_config_home().."awesome/bg/"
local theme_dir = gfs.get_xdg_config_home().."awesome/themes/default/"
...
theme.wallpaper = bg_dir.."demon_slayer_obanai_iguro.jpg"
